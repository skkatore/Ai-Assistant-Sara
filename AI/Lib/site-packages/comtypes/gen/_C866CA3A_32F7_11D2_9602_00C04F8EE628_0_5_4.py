...
__all__ = [
    'DISPID_SRDisplayUI', 'SpeechLoadOption',
    'DISPID_SpeechCustomStream', 'DISPID_SRCERecognizerStateChange',
    'SSSPTRelativeToEnd', 'DISPID_SPAsCount', 'SREPhraseStart',
    'SpeechCategoryAudioOut', 'SpeechAudioFormatGUIDText',
    'STSF_CommonAppData', 'DISPID_SRRecognizer', 'SPSSuppressWord',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRCResume', 'SAFT11kHz8BitStereo',
    'DISPID_SPEDisplayAttributes', 'SVPAlert', 'DISPID_SLWsCount',
    'SITooFast', 'SAFT8kHz8BitMono', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPEAudioSizeTime', 'SPGRAMMARWORDTYPE', 'DISPID_SRGReset',
    'DISPID_SGRClear', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechVoiceStatus', 'SPEI_TTS_AUDIO_LEVEL', 'SPSMF_UPS',
    'DISPID_SGRAttributes', 'ISpXMLRecoResult', 'SpShortcut',
    'SGLexical', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPEEngineConfidence', 'DISPID_SPEAudioSizeBytes',
    'SPEI_INTERFERENCE', 'SPEI_RESERVED2', 'DISPID_SDKCreateKey',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPIStartTime', 'SSFMCreate',
    'SPSHORTCUTPAIRLIST', 'SPWORDPRONUNCIATION',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRCEInterference',
    'DISPID_SGRSTRule', 'SRARoot',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVSkip',
    'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_PRIVATE15',
    'ISpeechRecognizerStatus', 'SPINTERFERENCE_TOOLOUD',
    'SGDSActiveWithAutoPause', 'DISPID_SRRTStreamTime',
    'ISpeechRecoResultTimes', 'SPDKL_DefaultLocation',
    'SAFTADPCM_11kHzMono', 'DISPID_SPCPhoneToId',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechGrammarRules',
    'DISPID_SDKSetBinaryValue', 'SPSHT_Unknown',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SDKSetLongValue',
    'SGDSActive', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSHT_EMAIL', 'SPEI_ADAPTATION', 'SpeechUserTraining', 'SVP_15',
    'SDTAll', 'SpeechRecoEvents', 'DISPID_SBSSeek',
    'DISPID_SPIEngineId', 'ISpStream', 'SECNormalConfidence',
    'DISPID_SpeechFileStream', 'DISPID_SpeechAudioFormat',
    'ISpRecoGrammar2', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SMSSetData', 'SpMMAudioIn',
    'DISPID_SOTRemoveStorageFileName', 'ISpeechRecoContext',
    'SPSERIALIZEDPHRASE', 'SPEI_TTS_BOOKMARK', 'DISPID_SOTCId',
    'eLEXTYPE_PRIVATE6', 'DISPID_SMSAMMHandle', 'DISPID_SGRSTsCount',
    'DISPID_SFSOpen', 'SSTTWildcard', 'SpResourceManager',
    'eLEXTYPE_PRIVATE12', 'SPWORD', 'SpSharedRecognizer',
    'eLEXTYPE_PRIVATE14', 'SPBO_NONE', 'SPCT_DICTATION', 'SPPS_Verb',
    'DISPID_SRCEPropertyStringChange', 'SpeechVoiceSpeakFlags',
    'SAFT24kHz8BitStereo', 'SGDSActiveUserDelimited',
    'SPEI_START_INPUT_STREAM', 'SRCS_Disabled',
    'DISPID_SpeechPhraseReplacement', 'SpeechTokenShellFolder',
    'eLEXTYPE_PRIVATE17', 'eLEXTYPE_MORPHOLOGY',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SCSBaseStream',
    'ISpeechPhraseAlternates', 'DISPID_SOTGetAttribute',
    'eLEXTYPE_RESERVED9', 'DISPID_SRCEventInterests', 'SP_VISEME_14',
    'eLEXTYPE_PRIVATE4', 'SpeechTokenContext',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechRecoResult',
    'DISPID_SABufferInfo', 'DISPID_SVEventInterests',
    'SAFT44kHz16BitStereo', 'DISPID_SRCCmdMaxAlternates',
    'SPRS_ACTIVE', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRCRequestedUIType', 'DISPID_SRRTLength',
    'SAFT16kHz16BitStereo', 'SVPNormal', 'DISPID_SPPsItem',
    'DISPID_SRSCurrentStreamPosition', 'ISpEventSink', 'ISpeechAudio',
    'SpeechPropertyResourceUsage', 'DISPID_SVESentenceBoundary',
    'SPFM_OPEN_READWRITE', 'SDTProperty', 'SPAS_CLOSED',
    'ISpRecoGrammar', 'eLEXTYPE_PRIVATE11', 'ISpNotifySource',
    'DISPID_SABIEventBias', 'DISPID_SVVolume', 'SPXRO_Alternates_SML',
    'DISPID_SGRsCount', 'DISPID_SLPLangId', 'SpeechRuleAttributes',
    'ISpeechPhraseAlternate', 'DISPID_SLPsItem', 'SRTReSent',
    'SGRSTTTextBuffer', 'SPBOOKMARKOPTIONS', 'SVEEndInputStream',
    'SpeechAudioFormatGUIDWave', 'DISPID_SMSGetData',
    'SpeechEmulationCompareFlags', 'DISPID_SOTGetDescription',
    'DISPID_SRStatus', 'DISPID_SRCERequestUI',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechGrammarRule', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SDKGetBinaryValue', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPIGetDisplayAttributes', 'SGRSTTWildcard',
    'DISPID_SRGSetTextSelection', 'DISPID_SVSInputSentenceLength',
    'SpeechVoicePriority', 'DISPID_SVEStreamEnd', 'SPGS_DISABLED',
    'SVEWordBoundary', 'DISPID_SDKOpenKey', 'SVP_14', 'STSF_AppData',
    'SpUnCompressedLexicon', 'ISpeechWaveFormatEx', 'SLTApp',
    'DISPID_SPRuleParent', 'DISPID_SVAudioOutputStream',
    'DISPID_SVSpeakStream', 'SpeechStreamSeekPositionType',
    'SPRULESTATE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVF_None',
    'DISPID_SOTCEnumerateTokens', 'SPBO_AHEAD',
    'DISPID_SRGCmdLoadFromResource',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SRSNumberOfActiveRules', 'SpeechInterference',
    'SPEI_RECOGNITION', 'DISPID_SPCLangId',
    'SpeechCategoryPhoneConverters', 'SAFTCCITT_ALaw_8kHzMono',
    'SRAImport', 'DISPID_SDKGetlongValue', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVSLastResult', 'SPEI_SR_BOOKMARK', 'SASRun',
    'SP_VISEME_0', 'DISPID_SLWs_NewEnum', 'SPRS_INACTIVE',
    'SpeechAllElements', 'SpeechRetainedAudioOptions',
    'SAFT16kHz16BitMono', 'SINoise', 'DISPID_SRGRecoContext',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT24kHz16BitMono',
    'SSFMCreateForWrite', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRsItem', 'SAFT12kHz16BitStereo', 'SPAUDIOOPTIONS',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPAs_NewEnum', 'SPEI_PHONEME',
    'STCInprocServer', 'SVP_18', 'SPSHT_NotOverriden',
    'ISpProperties', 'DISPID_SpeechXMLRecoResult',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPPsCount',
    'SpeechRegistryUserRoot', 'DISPID_SGRsItem', 'DISPID_SFSClose',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPPParent',
    'SPPS_SuppressWord', 'DISPID_SPERequiredConfidence',
    'SpInprocRecognizer', 'SpeechPropertyNormalConfidenceThreshold',
    'eLEXTYPE_PRIVATE13', 'eWORDTYPE_DELETED', 'SAFT32kHz16BitStereo',
    'IStream', 'SAFTCCITT_ALaw_11kHzStereo', 'SVP_3',
    'ISpeechPhoneConverter', 'SPVPRI_NORMAL',
    'DISPID_SVSInputWordPosition', 'SITooQuiet',
    'DISPID_SPARecoResult', 'SPSNoun', 'DISPID_SPRuleName',
    'DISPID_SpeechVoiceEvent', 'SFTSREngine', 'SVSFDefault',
    'SpeechTokenKeyAttributes', 'DISPID_SGRsFindRule',
    'SpNotifyTranslator', 'SAFT24kHz8BitMono',
    'DISPID_SPRFirstElement',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'IEnumString',
    'DISPID_SRCEStartStream', 'DISPID_SAVolume',
    'DISPID_SPCIdToPhone', 'SDTDisplayText', 'SRSEDone',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpObjectTokenCategory',
    'SPEI_RESERVED3', 'ISpeechPhraseProperty', 'SP_VISEME_6',
    'eLEXTYPE_RESERVED7', 'DISPID_SRGCommit',
    'DISPID_SRCVoicePurgeEvent', 'ISpRecognizer', 'DISPID_SPIGetText',
    'SVSFNLPSpeakPunc', 'SAFT22kHz8BitStereo', 'DISPID_SVRate',
    'ISpeechPhraseRules', 'DISPID_SVSPhonemeId', 'DISPID_SOTSetId',
    'SAFT24kHz16BitStereo', '_ISpeechRecoContextEvents',
    'DISPID_SLWWord', 'SPWT_DISPLAY', 'SPEI_VOICE_CHANGE',
    'DISPID_SGRSAddSpecialTransition', 'SPSVerb',
    'DISPIDSPTSI_SelectionOffset', 'SDTAudio',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPILanguageId',
    'DISPID_SGRSTPropertyId', 'SVEAllEvents', 'SPSHORTCUTTYPE',
    'SVSFIsXML', 'SpeechVoiceEvents', 'DISPID_SOTsItem',
    'SPEI_RESERVED5', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SpeechVoice', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPEDisplayText',
    'SAFTGSM610_8kHzMono', 'SP_VISEME_4',
    'DISPID_SpeechPhraseElements', 'SPVOICESTATUS', 'DISPID_SGRSRule',
    'SPEI_START_SR_STREAM', 'SPVPRIORITY',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SBSWrite',
    'DISPID_SGRSTText', 'DISPID_SPPFirstElement', 'SREStateChange',
    'SDA_No_Trailing_Space', 'eLEXTYPE_PRIVATE9',
    'DISPID_SWFESamplesPerSec', 'SAFT48kHz8BitMono',
    'SAFTGSM610_11kHzMono', 'SpeechTokenValueCLSID',
    'ISpGrammarBuilder', 'ISpPhrase', 'SP_VISEME_1', 'SPEI_MIN_TTS',
    'SAFTADPCM_22kHzStereo', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SRIsUISupported', 'SGRSTTDictation', 'SSTTTextBuffer',
    'DISPID_SPRuleNumberOfElements', 'SPEI_END_SR_STREAM',
    'SLODynamic', 'DISPID_SPPChildren', 'SPPHRASE', 'SPSNotOverriden',
    'DISPID_SRRAlternates', 'DISPID_SPEsCount',
    'ISpeechLexiconPronunciation', 'DISPIDSPTSI',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPAR_Medium',
    'DISPID_SPAsItem', 'ISpStreamFormatConverter',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechAudioStatus',
    'DISPID_SPELexicalForm', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechAudio', 'SBONone', 'DISPID_SWFEChannels',
    'SAFTGSM610_44kHzMono', 'SPSEMANTICERRORINFO',
    'DISPID_SOTMatchesAttributes', 'SP_VISEME_19',
    'SDKLCurrentConfig', 'ISpeechAudioStatus',
    'DISPID_SPPNumberOfElements', 'SPPHRASEELEMENT',
    'SAFT8kHz8BitStereo', 'DISPID_SVEViseme', 'SPAR_High',
    'DISPID_SOTs_NewEnum', 'DISPID_SVEBookmark', 'SPPS_Noncontent',
    'SpeechEngineConfidence', 'SpeechTokenKeyFiles',
    'ISpObjectWithToken', 'SP_VISEME_11', 'DISPID_SRCESoundEnd',
    'SAFT22kHz8BitMono', 'DISPID_SpeechPhraseElement',
    'ISpPhoneConverter', 'SPAUDIOSTATUS', 'SRESoundStart', 'SPPS_LMA',
    'SVSFIsNotXML', 'DISPID_SPPConfidence', 'DISPID_SGRSTNextState',
    'SVP_7', 'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechBaseStream', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTsCount', 'Speech_StreamPos_Asap',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechAudioState', 'ISpDataKey',
    'DISPID_SpeechRecoContext', 'SpeechDataKeyLocation',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_PRIVATE5',
    'SpObjectToken', 'DISPID_SVGetVoices', 'SDTReplacement',
    'DISPID_SRCEBookmark', 'SPFM_OPEN_READONLY', 'SAFT12kHz8BitMono',
    'ISpeechMemoryStream', 'DISPID_SASNonBlockingIO', 'WAVEFORMATEX',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechCategoryRecognizers', 'SREInterference',
    'DISPID_SpeechPhraseProperties', 'SpeechRecoProfileProperties',
    'SAFT16kHz8BitStereo', 'SPADAPTATIONRELEVANCE',
    'DISPID_SABufferNotifySize', 'IEnumSpObjectTokens',
    'eLEXTYPE_PRIVATE7', 'DISPID_SMSALineId', 'DISPID_SVVoice',
    'ISpeechGrammarRule', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SRADefaultToActive', 'DISPID_SRAudioInput', 'DISPID_SOTCSetId',
    'SpeechRecoContextState', 'DISPID_SPIElements',
    'SAFT32kHz8BitMono', 'SPCONTEXTSTATE', 'SVP_12', 'SGDSInactive',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SMSADeviceId',
    'SECHighConfidence', 'DISPID_SRCSetAdaptationData', 'SPLO_STATIC',
    'SREAudioLevel', 'DISPID_SDKEnumKeys', 'DISPID_SASetState',
    'DISPID_SpeechAudioBufferInfo', 'SVSFlagsAsync', 'ISpLexicon',
    'SPBO_TIME_UNITS', 'DISPID_SASFreeBufferSpace', 'SVEPrivate',
    'DISPID_SWFEBitsPerSample', 'STSF_FlagCreate',
    'SPRECOCONTEXTSTATUS', 'SP_VISEME_20', 'SPCS_ENABLED',
    'SPWF_SRENGINE', 'SVSFVoiceMask',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRRTimes',
    'SP_VISEME_7', 'DISPID_SVAudioOutput', 'DISPID_SRRPhraseInfo',
    'DISPID_SVGetProfiles', 'SAFT8kHz16BitMono',
    'SPRST_ACTIVE_ALWAYS', 'ISpRecoContext2', 'eLEXTYPE_USER',
    'ISpeechLexiconPronunciations', 'DISPID_SPRsCount', 'SpStream',
    'DISPID_SWFEBlockAlign', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechRuleState', 'SPVISEMES',
    'eLEXTYPE_PRIVATE16', 'ISpRecoCategory',
    'DISPID_SpeechRecoResult2', 'SP_VISEME_8',
    'DISPID_SABIBufferSize', 'DISPID_SLAddPronunciation',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPISaveToMemory',
    'DISPID_SPIRule', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFTNonStandardFormat', '_SPAUDIOSTATE',
    'DISPID_SLWPronunciations', 'IInternetSecurityMgrSite',
    'SAFTADPCM_22kHzMono', 'SRAONone', 'SVP_16', 'ISpeechRecoResult',
    'SVP_20', 'DISPID_SLGetWords', 'SDKLLocalMachine', 'SPCT_COMMAND',
    'SWTDeleted', 'DISPID_SGRSTWeight', 'SVEStartInputStream',
    'ISpeechLexiconWord', 'DISPID_SPEActualConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPRST_ACTIVE',
    'SRSEIsSpeaking', 'SpCustomStream', 'DISPID_SGRSTsItem',
    'SDKLDefaultLocation', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpeechPhraseInfoBuilder', 'DISPID_SAFType', 'SPEI_SOUND_START',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRRAudioFormat',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT8kHz16BitStereo',
    'DISPID_SLPSymbolic', 'SPPS_NotOverriden', 'SVSFParseMask',
    'SVP_17', 'SVF_Emphasis', 'DISPID_SGRSAddRuleTransition',
    'SpPhoneConverter', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechDataKey',
    'DISPID_SVEWord', 'SPAR_Low', 'SpeechTokenIdUserLexicon',
    'ISpeechPhraseReplacements', 'DISPID_SpeechWaveFormatEx',
    'SITooSlow', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRAudioInputStream', 'SPPS_Interjection',
    'DISPID_SOTDataKey', 'eLEXTYPE_VENDORLEXICON', 'SPSHORTCUTPAIR',
    'SP_VISEME_16', 'UINT_PTR', 'SRTExtendableParse', 'SRESoundEnd',
    'SVSFUnusedFlags', 'SPEVENTENUM', 'SREStreamStart',
    'SDA_One_Trailing_Space', 'ISpNotifyTranslator', 'SREStreamEnd',
    'SVEBookmark', 'SpVoice', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPAPhraseInfo', 'DISPID_SVGetAudioOutputs', 'SVP_8',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPRuleChildren',
    'SVP_6', 'SPEI_UNDEFINED', 'SDKLCurrentUser', 'SPVPRI_OVER',
    'SPAR_Unknown', 'SPPS_RESERVED2', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SLPsCount', 'SECFEmulateResult', 'DISPID_SRCEAdaptation',
    'SAFT48kHz16BitStereo', 'DISPID_SVSInputWordLength',
    'DISPID_SVSVisemeId', 'DISPID_SPEs_NewEnum', 'SPPS_Noun',
    'DISPID_SpeechPhraseProperty', 'DISPID_SOTId',
    'DISPID_SPIProperties', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechPhoneConverter', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SGRAddState',
    'SRSInactive', 'ISpPhoneticAlphabetSelection',
    'DISPID_SLPPhoneIds', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_WORD_BOUNDARY', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechLexiconProns', 'DISPID_SAFGuid', 'SRERequestUI',
    'SGDisplay', 'SpeechVisemeType', 'DISPID_SRRSetTextFeedback',
    'SGRSTTEpsilon', 'SVP_13', 'SVESentenceBoundary', 'SPEI_MAX_TTS',
    'SpeechWordPronounceable', 'SAFT44kHz8BitMono',
    'DISPID_SPRs_NewEnum', 'SpeechPropertyAdaptationOn',
    'SRTAutopause', 'SPGS_ENABLED', 'DISPID_SRRSpeakAudio',
    'SpeechVisemeFeature', 'ISpSerializeState',
    'SpeechAudioFormatType', 'DISPID_SLGetGenerationChange',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechPhraseRule',
    'DISPID_SVPause', 'SPEI_MAX_SR',
    'DISPID_SVSLastStreamNumberQueued', 'SPPS_RESERVED3',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechRecoResultTimes',
    'SpeechStreamFileMode', 'SVP_9', 'SPFM_CREATE',
    'DISPID_SpeechRecoContextEvents', 'ISpeechObjectTokens',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPRNumberOfElements',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCreateRecoContext',
    'SPSTREAMFORMATTYPE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTRemove',
    'SpeechEngineProperties', 'SAFTADPCM_8kHzMono',
    'DISPIDSPTSI_SelectionLength', 'SPCT_SUB_DICTATION',
    'eLEXTYPE_RESERVED10', 'SSSPTRelativeToStart',
    'SAFT32kHz8BitStereo', 'DISPID_SRGCmdSetRuleState',
    'ISpeechObjectTokenCategory', 'SPVPRI_ALERT', 'SRTStandard',
    'SVSFPurgeBeforeSpeak', 'STCInprocHandler',
    'DISPID_SRCCreateGrammar', 'SPSHT_OTHER', 'STCRemoteServer',
    'SpeechTokenKeyUI', 'SECFIgnoreKanaType', 'SPEI_TTS_PRIVATE',
    'ISpeechRecognizer', 'SPINTERFERENCE_LATENCY_WARNING',
    'SRATopLevel', 'SPPHRASEPROPERTY', 'SPXMLRESULTOPTIONS',
    'ISpeechObjectToken', 'DISPID_SLPType', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRSTransitions', 'SPCT_SUB_COMMAND', 'SP_VISEME_9',
    'SPSLMA', 'SGRSTTWord', 'DISPID_SPIGrammarId',
    'SpNullPhoneConverter', 'SSSPTRelativeToCurrentPosition',
    'SpeechDiscardType', 'SVP_21', 'SPAUDIOBUFFERINFO',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCState', 'SpeechAudioVolume',
    'DISPID_SPIAudioStreamPosition', 'SpAudioFormat',
    'SREPropertyStringChange', 'SAFT22kHz16BitMono',
    'IInternetSecurityManager', 'SAFTDefault',
    'DISPID_SPIReplacements', 'eLEXTYPE_RESERVED8',
    'ISpeechPhraseProperties', 'DISPID_SPACommit',
    'ISpeechMMSysAudio', 'SP_VISEME_21', 'SVP_5',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPGS_EXCLUSIVE',
    'SpeechCategoryRecoProfiles', 'SPTEXTSELECTIONINFO',
    'SpeechAddRemoveWord', 'SGSExclusive',
    'DISPID_SGRSTPropertyValue', 'SRSActiveAlways',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SLWType',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRSetPropertyString',
    'DISPID_SRGIsPronounceable', 'tagSPPROPERTYINFO',
    'DISPID_SVPriority', 'SP_VISEME_13', 'ISpeechVoice',
    'SPCATEGORYTYPE', 'LONG_PTR', 'SVSFPersistXML',
    ...
    'DISPID_SGRInitialState', 'ISpeechRecoResultDispatch',
    'SpeechDictationTopicSpelling', 'DISPID_SRGetFormat', 'SPEVENT',
    'SpeechRecognitionType', 'DISPID_SRCVoice', 'SINoSignal',
    'SPWORDPRONOUNCEABLE', 'SAFT11kHz16BitMono', 'SAFT11kHz8BitMono',
    'SPPS_Modifier', 'SP_VISEME_5', 'SAFT12kHz16BitMono',
    'SAFT32kHz16BitMono', 'DISPID_SVSInputSentencePosition',
    'SPSInterjection', 'SPPROPERTYINFO', 'SAFT44kHz16BitMono',
    'SPRULE', 'SAFTADPCM_8kHzStereo', 'ISpeechGrammarRuleState',
    'DISPID_SOTIsUISupported', 'DISPID_SVEPhoneme',
    'SPRST_NUM_STATES', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechPartOfSpeech', 'DISPID_SOTDisplayUI', 'SRSActive',
    'SPEI_SR_PRIVATE', 'SpeechGrammarWordType', 'SpMemoryStream',
    'SECLowConfidence', 'SRTSMLTimeout', 'DISPID_SGRs_NewEnum',
    'ISpeechRecoGrammar', 'eLEXTYPE_PRIVATE3', 'SVP_0',
    'SpeechSpecialTransitionType', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechPhraseReplacement', 'STCAll', 'SPWORDLIST',
    'DISPID_SpeechGrammarRuleStateTransition', 'SP_VISEME_10',
    'SPWF_INPUT', 'SAFT48kHz8BitStereo',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVAlertBoundary',
    'DISPID_SDKSetStringValue', 'SpObjectTokenCategory',
    'DISPID_SDKGetStringValue', 'SLOStatic', 'DISPID_SVEAudioLevel',
    'DISPID_SOTCGetDataKey', 'SPWT_LEXICAL',
    'DISPID_SVGetAudioInputs', 'DISPID_SPAStartElementInResult',
    'SpLexicon', 'DISPID_SVIsUISupported', 'SWTAdded',
    'ISpeechFileStream', 'SAFT22kHz16BitStereo',
    'DISPID_SRRTTickCount', 'ISpeechXMLRecoResult',
    'DISPID_SGRSTType', 'SECFIgnoreCase', 'DISPID_SPEPronunciation',
    'ISpAudio', 'DISPID_SRState', 'DISPID_SpeechObjectToken',
    'SVF_Stressed', 'SPCS_DISABLED', '_RemotableHandle',
    'DISPID_SLRemovePronunciation', 'SSTTDictation',
    '_ISpeechVoiceEvents', 'ISpeechCustomStream', 'SP_VISEME_18',
    'SPRST_INACTIVE', 'DISPID_SRGetRecognizers',
    'SPDKL_CurrentConfig', 'SPINTERFERENCE_NONE',
    'DISPID_SPEAudioStreamOffset', 'SPSEMANTICFORMAT',
    'DISPID_SRCRecognizer', 'SRADynamic', 'SAFT11kHz16BitStereo',
    'Speech_Default_Weight', 'DISPID_SPRuleId', 'SPEI_RESERVED1',
    'SSFMOpenForRead', 'DISPID_SRCEAudioLevel',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPPs_NewEnum',
    'SAFTExtendedAudioFormat', 'SGSDisabled', 'DISPID_SLGenerationId',
    'SRERecognition', 'SPINTERFERENCE', 'DISPID_SBSRead',
    'DISPID_SRGetPropertyNumber', 'SVSFParseSapi',
    'SPSERIALIZEDRESULT', 'ISpResourceManager', 'SPEI_HYPOTHESIS',
    'SVP_4', 'SP_VISEME_15', 'ISpeechLexicon',
    'Speech_Max_Pron_Length', 'DISPID_SVEStreamStart',
    'ISpeechRecoResult2', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechPhraseBuilder', 'SpCompressedLexicon',
    'ISpeechPhraseElements', 'DISPID_SRSClsidEngine',
    'SVSFParseAutodetect', 'DISPID_SpeechLexicon', 'SGPronounciation',
    'DISPID_SVSCurrentStreamNumber',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVDisplayUI', 'tagSTATSTG', 'SPAO_NONE',
    'DISPID_SpeechVoiceStatus', 'SPEI_RESERVED6', 'SVP_10',
    'SPEI_MIN_SR', 'SpPhoneticAlphabetConverter', 'SRTEmulated',
    'DISPID_SABIMinNotification', 'SVEVoiceChange',
    'DISPID_SOTCategory', 'ISpRecoContext', 'SDTAlternates',
    'SpMMAudioEnum', 'DISPID_SRCEEnginePrivate', 'DISPID_SLWLangId',
    'SREPropertyNumChange', 'SPPS_RESERVED1', 'SRERecoOtherContext',
    'SREFalseRecognition', 'SRAExport', 'SpeechMicTraining',
    'DISPID_SOTCDefault', 'ISpNotifySink', 'DISPID_SDKDeleteKey',
    'SpPhraseInfoBuilder', 'DISPIDSPRG', 'ISpMMSysAudio',
    'DISPID_SPPId', 'eLEXTYPE_RESERVED4', 'SPAUDIOSTATE', 'SFTInput',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRGCmdLoadFromFile',
    'SVSFParseSsml', 'SVSFNLPMask', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRName', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRGetPropertyString', 'DISPID_SRGState',
    'DISPID_SRRAudio', 'SAFT12kHz8BitStereo', 'DISPID_SPRText',
    'DISPID_SpeechRecognizer', 'SRCS_Enabled', 'SAFTNoAssignedFormat',
    'Speech_Max_Word_Length', 'SDTRule', 'SAFTCCITT_uLaw_8kHzMono',
    'SPAS_RUN', 'DISPID_SRCBookmark', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPLEXICONTYPE', 'SPPS_RESERVED4', 'SAFTCCITT_uLaw_11kHzStereo',
    'SVPOver', 'SAFTText', 'DISPID_SOTCreateInstance',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_PRIVATE1',
    'eLEXTYPE_RESERVED6', 'DISPID_SRRSaveToMemory',
    'DISPID_SGRAddResource', 'eLEXTYPE_PRIVATE10', 'SpeechRunState',
    'SASClosed', 'SPEI_VISEME', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVSpeak', 'SpeechBookmarkOptions', 'DISPID_SAEventHandle',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechLexiconWords',
    'SpeechLexiconType', 'SP_VISEME_12', 'SpeechGrammarState',
    'SAFTADPCM_44kHzMono', 'SPAS_STOP', 'SPFILEMODE', 'DISPID_SGRId',
    'SREPrivate', 'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_REQUEST_UI',
    'SpeechWordType', 'ISpeechPhraseRule', 'SECFDefault',
    'DISPID_SpeechLexiconPronunciation', 'SpSharedRecoContext',
    'SITooLoud', 'SAFT48kHz16BitMono', 'DISPID_SVSLastBookmark',
    'DISPID_SVEEnginePrivate', 'SAFTCCITT_ALaw_44kHzMono',
    'SPPARTOFSPEECH', 'SPEVENTSOURCEINFO', 'DISPID_SGRsAdd',
    'ISpRecognizer2', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPEsItem', 'SPFM_CREATE_ALWAYS', 'DISPID_SVEVoiceChange',
    'ISpeechDataKey', 'DISPID_SRGDictationSetState', 'SP_VISEME_17',
    'DISPID_SpeechPhraseRules', 'SVP_1',
    'SWPUnknownWordPronounceable', 'SAFTGSM610_22kHzMono',
    'ISpeechAudioFormat', 'SAFTCCITT_ALaw_8kHzStereo', 'SP_VISEME_2',
    'DISPID_SBSFormat', 'SpeechDisplayAttributes',
    'ISequentialStream', 'SPWT_PRONUNCIATION',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRSSupportedLanguages',
    'SPLOADOPTIONS', 'SASStop', 'ISpeechAudioBufferInfo',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLGetPronunciations',
    'DISPID_SRIsShared', 'ISpRecoResult', 'DISPID_SRCESoundStart',
    'ISpRecognizer3', 'SPRECOGNIZERSTATUS',
    'SpeechGrammarTagDictation', 'SPXRO_SML', 'SPAO_RETAIN_AUDIO',
    'SECFNoSpecialChars', 'DISPID_SVWaitUntilDone', 'DISPID_SPPValue',
    'SVP_11', 'SPDATAKEYLOCATION', 'SREHypothesis',
    'SpeechFormatType', 'Speech_StreamPos_RealTime',
    'SAFTADPCM_44kHzStereo', 'eLEXTYPE_APP', 'SPPS_Unknown',
    'DISPID_SVSRunningState', 'ISpeechGrammarRules',
    'DISPID_SPPEngineConfidence', 'DISPID_SADefaultFormat',
    'SPEI_RECO_OTHER_CONTEXT', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SpeechRecognizerStatus',
    'SGSEnabled', 'ISpShortcut', 'SPSUnknown', 'SPSFunction',
    'SVEPhoneme', 'SAFT44kHz8BitStereo', 'SBOPause',
    'DISPID_SGRsDynamic', 'SPEI_FALSE_RECOGNITION', 'SPFM_NUM_MODES',
    'SpFileStream', 'SVP_2', 'DISPID_SGRSTPropertyName',
    'SPRECOSTATE', 'SpeechGrammarTagWildcard', 'SGRSTTRule',
    'ISpVoice', 'ISpeechPhraseElement', 'DISPID_SAFSetWaveFormatEx',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_SR_AUDIO_LEVEL',
    'SSFMOpenReadWrite', 'SDA_Consume_Leading_Spaces', 'SPLO_DYNAMIC',
    'SpeechRecognizerState', 'DISPID_SLWsItem', 'DISPID_SRGRules',
    'SGLexicalNoSpecialChars', 'DISPID_SPRulesCount', 'SP_VISEME_3',
    'SpeechAudioProperties', 'DISPID_SRGDictationUnload',
    'ISpEventSource', 'eWORDTYPE_ADDED', 'SRSInactiveWithPurge',
    'STCLocalServer', 'DISPID_SRSAudioStatus',
    'SpeechGrammarRuleStateTransitionType', 'SPBO_PAUSE',
    'SRAORetainAudio', 'SPEI_END_INPUT_STREAM',
    'DISPID_SWFEAvgBytesPerSec', 'SPWAVEFORMATTYPE',
    'DISPID_SpeechObjectTokenCategory', 'SVEAudioLevel',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SWFEExtraData',
    'SVSFIsFilename', 'STSF_LocalAppData', 'SREBookmark', 'SINone',
    'SpeechCategoryAudioIn', 'SPINTERFERENCE_NOISE',
    'ISpeechResourceLoader', 'DISPID_SRCEPhraseStart',
    'SPBINARYGRAMMAR', 'DISPID_SGRsCommit', 'SLTUser', 'DISPID_SRGId',
    'SpInProcRecoContext', 'SpMMAudioOut', 'DISPID_SDKDeleteValue',
    'DISPID_SWFEFormatTag', 'DISPID_SpeechMemoryStream',
    'SDTLexicalForm', 'SASPause', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRRecoContext', 'SPAS_PAUSE', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCPause', 'DISPID_SRCERecognition',
    'SpeechCategoryVoices', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechBaseStream',
    'SPPHRASERULE', 'ISpStreamFormat', 'SECFIgnoreWidth',
    'SPDKL_LocalMachine', 'SpStreamFormatConverter', 'SPGRAMMARSTATE',
    'SWPKnownWordPronounceable', 'DISPID_SRProfile',
    'ISpeechPhraseInfo', 'DISPID_SPPName', 'SREAdaptation',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRRGetXMLResult',
    'SPDKL_CurrentUser', 'SPPS_Function', 'ISpPhraseAlt',
    'DISPID_SVResume', 'SPRECORESULTTIMES', 'SPEI_RECO_STATE_CHANGE',
    'SPWORDTYPE', 'SVP_19', 'DISPID_SRSetPropertyNumber',
    'SPEI_PHRASE_START', 'DISPID_SREmulateRecognition', 'SVEViseme',
    'DISPID_SAStatus', 'DISPID_SPRuleConfidence', 'SRAInterpreter',
    'ISpObjectToken', 'DISPID_SpeechPhraseAlternate',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SDKEnumValues',
    'SDTPronunciation', 'DISPID_SLPs_NewEnum', 'SpWaveFormatEx',
    'DISPID_SRCEEndStream', 'SREAllEvents', 'DISPID_SVStatus',
    'DISPID_SPRuleFirstElement', 'DISPID_SPRulesItem',
    'DISPID_SGRSAddWordTransition', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE18', 'SPCT_SLEEP', 'SPSModifier',
    'ISpeechTextSelectionInformation', 'SPEI_SOUND_END'
]
